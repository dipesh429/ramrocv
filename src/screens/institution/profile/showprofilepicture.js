...
import { upload } from '../../../actions/employer';
    ...
    render(){
        return (
            ...
            <Box style="primary" loading={this.props.loading}>
                <Box.Header>
                    <Box.Title>Institution Emblem</Box.Title>
                    <Box.Tools>
...
export default connect(state => ({
    ...
    loading: state.employer.pictureloading,
    uploaded: state.employer.uploaded,
    photo: state.employer.image
}), dispatch => ({
    upload: (data, id) => upload(dispatch, data, id)
}))(ShowProfilePicture);